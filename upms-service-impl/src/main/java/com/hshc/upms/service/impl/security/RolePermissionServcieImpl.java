...
import com.hshc.upms.dao.security.RolePermissionMapper;
import com.hshc.upms.entity.security.Resource;
import com.hshc.upms.entity.security.RolePermission;
import com.hshc.upms.entity.utils.ResourceTreeUtils;
...
extends BaseServiceImpl<T, ID> implements RolePermissionService<T, ID>{
	...
	/* (non-Javadoc)
	 * @see com.hshc.upms.service.api.security.RolePermissionService#createDataPermission(java.util.List)
	 */
	@Override
	public void createDataPermission(Map<String, Object> dataCodeList) {
		rolePermissionMapper.createDataPermission(dataCodeList);
