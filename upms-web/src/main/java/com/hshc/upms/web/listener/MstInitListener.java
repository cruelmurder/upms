package com.hshc.upms.web.listener;
...
public class MstInitListener extends ContextLoaderListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        Map<String, List<MstRegion>> cityMap = new HashMap<String, List<MstRegion>>();
        Map<String, List<MstRegion>> countyMap = new HashMap<String, List<MstRegion>>();
