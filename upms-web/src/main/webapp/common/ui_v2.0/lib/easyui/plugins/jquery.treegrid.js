...
(function($) {
	...
	function _8a(_8b, _8c) {
		...
		if (_8c.parent) {
			...
			if (_8f.hasClass("tree-file")) {
				_8f.removeClass("tree-file").addClass(
			...
			if (_a1) {
				...
				_a1 = $.data(this, "treegrid", {
					options : $.extend({}, $.fn.treegrid.defaults,
							$.fn.treegrid.parseOptions(this), _9e),
					data : []
				});
			}
			_1(this);
	...
	$.fn.treegrid.methods = {
		...
		reloadFooter : function(jq, _a9) {
			return jq.each(function() {
				...
				if (_aa.showFooter) {
					_aa.view.renderFooter
							.call(_aa.view, this, dc.footer1, true);
					_aa.view.renderFooter.call(_aa.view, this, dc.footer2,
							false);
	...
	$.fn.treegrid.parseOptions = function(_b1) {
		return $.extend({}, $.fn.datagrid.parseOptions(_b1), $.parser
				.parseOptions(_b1, [ "treeField", {
					animate : "boolean"
				} ]));
	};
	var _b2 = $
					...
					$.fn.datagrid.defaults.view,
					{
						render : function(_b3, _b4, _b5) {
							...
							function _bc(_bd, _be, _bf) {
								...
								for (var i = 0; i < _bf.length; i++) {
									...
									var css = _b6.rowStyler ? _b6.rowStyler
											.call(_b3, row) : "";
									var _c1 = "";
									var _c2 = "";
									...
									var cls = "class=\"datagrid-row "
											+ (_b9++ % 2 && _b6.striped ? "datagrid-row-alt "
													: " ") + _c1 + "\"";
									...
									_c0.push("<tr id=\"" + _c4
											...
											+ row[_b6.idField] + "\" " + cls
											+ " " + _c3 + ">");
									_c0 = _c0.concat(_ba.renderRow.call(_ba,
											_b3, _b7, _bd, _be, row));
									_c0.push("</tr>");
						...
						renderFooter : function(_c5, _c6, _c7) {
							...
							for (var i = 0; i < _c9.length; i++) {
								var row = _c9[i];
								row[_c8.idField] = row[_c8.idField]
										|| ("foot-row-id" + i);
								_cb
										.push("<tr class=\"datagrid-row\" node-id=\""
												+ row[_c8.idField] + "\">");
								_cb.push(this.renderRow.call(this, _c5, _ca,
										_c7, 0, row));
								_cb.push("</tr>");
							}
						...
						renderRow : function(_cc, _cd, _ce, _cf, row) {
							...
							for (var i = 0; i < _cd.length; i++) {
								var _d1 = _cd[i];
								var col = $(_cc).datagrid("getColumnOption",
										_d1);
								if (col) {
									...
									var cls = _d2 ? "class=\"" + _d2 + "\""
											: "";
									var _d4 = col.hidden ? "style=\"display:none;"
											+ _d3 + "\""
											: (_d3 ? "style=\"" + _d3 + "\""
													: "");
									cc.push("<td field=\"" + _d1 + "\" " + cls
											+ " " + _d4 + ">");
									var _d4 = "";
									if (!col.checkbox) {
										if (col.align) {
						...
						updateRow : function(_d6, id, row) {
							...
							var _da = _d7.rowStyler ? _d7.rowStyler.call(_d6,
									_d8) : "";
							function _db(_dc) {
								var _dd = $(_d6).treegrid("getColumnFields",
										_dc);
								var tr = _d7.finder.getTr(_d6, id, "body",
										(_dc ? 1 : 2));
								var _de = tr
								...
								var _df = tr
										...
										.is(":checked");
								tr
										.html(this.renderRow(_d6, _dd, _dc,
												_d9, _d8));
								tr.attr("style", _da || "");
						...
						deleteRow : function(_e0, id) {
							...
							if (_e2) {
								if (_e2.children.length == 0) {
									tr = _e1.finder
											.getTr(_e0, _e2[_e1.idField]);
									tr.next("tr.treegrid-tr-tree").remove();
									var _e3 = tr.children(
											"td[field=\"" + _e1.treeField
													+ "\"]").children(
											"div.datagrid-cell");
									_e3.find(".tree-icon").removeClass(
											"tree-folder")
											.addClass("tree-file");
						...
						finder : {
							getTr : function(_103, id, type, _104) {
								...
								if (_104 == 0) {
									...
									var tr1 = opts.finder.getTr(_103, id, type,
											1);
									var tr2 = opts.finder.getTr(_103, id, type,
											2);
									return tr1.add(tr2);
								} else {
									if (type == "body") {
										var tr = $("#"
												+ $.data(_103, "datagrid").rowIdPrefix
												+ "-" + _104 + "-" + id);
										if (!tr.length) {
											tr = (_104 == 1 ? dc.body1
													: dc.body2)
										...
										if (type == "footer") {
											return (_104 == 1 ? dc.footer1
													: dc.footer2)
													.find("tr[node-id=\"" + id
															+ "\"]");
										} else {
											if (type == "selected") {
												return (_104 == 1 ? dc.body1
														: dc.body2)
