...
(function($) {
			...
			if (_4c) {
				...
				_4c = $.data(this, "combobox", {
					options : $.extend({}, $.fn.combobox.defaults,
							$.fn.combobox.parseOptions(this), _49),
					data : []
				});
				_42(this);
	...
	$.fn.combobox.methods = {
		...
		clear : function(jq) {
			return jq.each(function() {
				...
				_51.find("div.combobox-item-selected").removeClass(
						"combobox-item-selected");
			});
		},
		reset : function(jq) {
	...
	$.fn.combobox.parseOptions = function(_56) {
		var t = $(_56);
		return $.extend({}, $.fn.combo.parseOptions(_56), $.parser
				.parseOptions(_56, [ "valueField", "textField", "groupField",
						"mode", "method", "url" ]));
	};
	...
	$.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults,
			{
				...
				filter : function(q, row) {
					...
					return row[_5e.textField].toLowerCase().indexOf(
							q.toLowerCase()) == 0;
				},
				...
				finder : {
					getEl : function(_66, _67) {
						var _68 = _2(_66, _67);
						var id = $.data(_66, "combobox").itemIdPrefix + "_"
								+ _68;
						return $("#" + id);
					},
					getRow : function(_69, p) {
						var _6a = $.data(_69, "combobox");
						var _6b = (p instanceof jQuery) ? p.attr("id").substr(
								_6a.itemIdPrefix.length + 1) : _2(_69, p);
