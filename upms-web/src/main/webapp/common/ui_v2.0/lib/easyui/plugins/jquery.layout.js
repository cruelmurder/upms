...
(function($) {
	...
	function _3d(_3e, _3f) {
		...
		var _42 = _43();
		var _44 = "expand" + _3f.substring(0, 1).toUpperCase()
				+ _3f.substring(1);
		if (_40[_44]) {
			_40[_44].panel("close");
			p.panel("panel").stop(true, true);
			p.panel("expand", false).panel("open")
					.panel("resize", _42.collapse);
					...
					if (_3f == "north" && _40.expandNorth) {
						...
						if (_3f == "south" && _40.expandSouth) {
							return {
								...
								expand : {
									top : cc.height()
											- _40["south"].panel("options").height
								}
							};
						}
					}
	...
	$.fn.layout = function(_49, _4a) {
		...
		return this.each(function() {
			...
			if (_4b) {
				...
				var _4c = $.extend({}, $.fn.layout.defaults, $.fn.layout
						.parseOptions(this), _49);
				$.data(this, "layout", {
					options : _4c,
					panels : {
						center : $(),
		...
		add : function(jq, _50) {
			return jq
					.each(function() {
						_1b(this, _50);
						_2(this);
						if ($(this).layout("panel", _50.region)
