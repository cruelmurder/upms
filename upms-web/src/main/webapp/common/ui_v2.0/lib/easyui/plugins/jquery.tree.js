...
(function($) {
	...
	function _e1(_e2, _e3) {
		...
		_e7.width(_e6 + 20);
		_e7.height(document.compatMode == "CSS1Compat" ? (18 - (_e7
				.outerHeight() - _e7.height())) : 18);
	...
	$.fn.tree = function(_f3, _f4) {
		...
		return this.each(function() {
			...
			if (_f5) {
				...
				_f6 = $.extend({}, $.fn.tree.defaults, $.fn.tree
						.parseOptions(this), _f3);
				$.data(this, "tree", {
					options : _f6,
					tree : _1(this),
					data : []
	...
	var _118 = {
		render : function(_119, ul, data) {
			...
			var _11a = $(ul).prev("div.tree-node").find(
			...
			function _11b(_11c, _11d) {
				...
				for (var i = 0; i < _11d.length; i++) {
					...
					cc.push("<span class=\"tree-title\">"
							+ opts.formatter.call(_119, item) + "</span>");
					cc.push("</div>");
					if (item.children && item.children.length) {
