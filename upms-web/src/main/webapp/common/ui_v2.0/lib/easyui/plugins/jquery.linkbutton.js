...
(function($) {
	function _1(_2) {
		...
		if (_3.iconCls) {
			$("<span class=\"l-btn-icon\">&nbsp;</span>").addClass(_3.iconCls)
					.appendTo(_4);
	...
	function _5(_7, _8) {
		...
		if (_8) {
			...
			$(_7).addClass(
					_9.plain ? "l-btn-selected l-btn-plain-selected"
							: "l-btn-selected");
			_9.selected = true;
		} else {
			if (!_9.group) {
	...
	function _6(_a, _b) {
		...
		if (_b) {
			...
			_d.plain ? $(_a).addClass("l-btn-disabled l-btn-plain-disabled")
					: $(_a).addClass("l-btn-disabled");
		} else {
			_d.disabled = false;
			if (_c.href) {
			...
			if (_11) {
				...
				$.data(this, "linkbutton", {
					options : $.extend({}, $.fn.linkbutton.defaults,
							$.fn.linkbutton.parseOptions(this), _f)
				});
	...
	$.fn.linkbutton.parseOptions = function(_12) {
		var t = $(_12);
		return $.extend({}, $.parser.parseOptions(_12, [ "id", "iconCls",
